  ...
  return <SafeAreaView edges={["top", "left", "right"]} style={{ flex: 1, backgroundColor: "#7C1117" }}>
    <ScrollView style={{ backgroundColor: "#F8FAFC" }} contentContainerStyle={{ paddingBottom: 120 }}>
      <View style={[h.header, gradient]}>
        ...
        <Pressable accessibilityRole="button" accessibilityLabel="Search doctors, hospitals, departments" onPress={() => navigate({ name: "care", kind: "doctors" })} style={h.search}><Glyph name="search-outline" color="#9CA3AF" size={20} /><Text numberOfLines={1} style={{ flex: 1, color: "#9CA3AF", fontSize: 13 }}>Search doctors, hospitals, departments...</Text></Pressable>
      </View>
