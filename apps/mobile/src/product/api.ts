...
export type Post = { id: string; content: string; type: string; imageUrl?: string; mediaUrls?: string[]; mediaTypes?: ("image" | "video")[]; tags?: string[]; documentUrls?: string[]; createdAt: string; likeCount?: number; commentCount?: number; author: { id: string; name: string; role?: string; image?: string } | null };
