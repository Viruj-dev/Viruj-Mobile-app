...
export function Heading({ children, style, numberOfLines, ellipsizeMode }: { children: ReactNode; style?: StyleProp<TextStyle>; numberOfLines?: number; ellipsizeMode?: "head" | "middle" | "tail" | "clip" }) { return <Text accessibilityRole="header" numberOfLines={numberOfLines} ellipsizeMode={ellipsizeMode} style={[s.heading, style]}>{children}</Text>; }
export function Body({ children, style, numberOfLines, ellipsizeMode }: { children: ReactNode; style?: StyleProp<TextStyle>; numberOfLines?: number; ellipsizeMode?: "head" | "middle" | "tail" | "clip" }) { return <Text numberOfLines={numberOfLines} ellipsizeMode={ellipsizeMode} style={[s.body, style]}>{children}</Text>; }
