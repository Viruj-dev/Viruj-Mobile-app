...
export const colors = { primary: "#B91C1C", deep: "#7F1D1D", ink: "#2B1C1C", muted: "#786666", bg: "#F8FAFC", line: "#EEE1DE", soft: "#FCECEA", white: "#FFFFFF", red: "#AC3434" };
...
export const s = StyleSheet.create({
  screen: { flex: 1, backgroundColor: colors.bg }, header: { paddingHorizontal: 22, paddingTop: 12, paddingBottom: 20, flexDirection: "row", alignItems: "center", gap: 10 }, title: { fontFamily: "Merienda", fontSize: 30, fontWeight: "700", letterSpacing: -1, color: colors.ink }, eyebrow: { color: colors.deep, fontSize: 11, fontWeight: "700", letterSpacing: 2, textTransform: "uppercase", marginBottom: 8 }, content: { paddingHorizontal: 22, paddingBottom: 120, gap: 18, flexGrow: 1 }, heading: { fontFamily: "Merienda", fontSize: 20, fontWeight: "600", letterSpacing: -0.5, color: colors.ink }, body: { fontFamily: "Merienda", fontSize: 14, lineHeight: 21, color: colors.muted }, label: { fontFamily: "Merienda", fontSize: 13, fontWeight: "600", color: colors.ink }, input: { fontFamily: "Merienda", borderWidth: 1, borderColor: colors.line, borderRadius: 16, padding: 15, minHeight: 52, color: colors.ink, backgroundColor: "white", fontSize: 16 }, button: { minHeight: 52, borderRadius: 16, backgroundColor: colors.deep, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: 18, paddingVertical: 12, gap: 8 }, secondary: { backgroundColor: colors.soft }, buttonText: { fontFamily: "Merienda", fontSize: 15, fontWeight: "600", color: "white" }, card: { backgroundColor: "white", padding: 19, borderRadius: 22, borderWidth: 1, borderColor: colors.line, gap: 12 }, error: { color: colors.red, fontSize: 14, lineHeight: 21 }, empty: { paddingVertical: 38, alignItems: "center", gap: 12 }, iconButton: { minWidth: 48, minHeight: 48, alignItems: "center", justifyContent: "center" }, row: { flexDirection: "row", alignItems: "center", gap: 14, minHeight: 76, paddingVertical: 8 }, rowTitle: { fontFamily: "Merienda", fontSize: 16, fontWeight: "600", color: colors.ink }, iconTile: { width: 46, height: 46, borderRadius: 15, backgroundColor: colors.soft, alignItems: "center", justifyContent: "center" },
});
